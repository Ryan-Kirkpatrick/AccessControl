...
CRGB::HTMLColorCode currentColor = CRGB::Blue; // Default interlock status led color is blue, let's start there.
...
void statusLight(CRGB::HTMLColorCode color) {
...
void setup() {
    ...
    FastLED.addLeds<NEOPIXEL, externalLEDPin>(leds, numberOfLEDs);
    statusLight(CRGB::Purple);
